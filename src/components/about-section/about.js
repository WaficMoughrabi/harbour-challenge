...
function AboutSection(){
    ...
    console.log(data.scholarship.program.photos[0].src);
// {data.scholarship.program.photos[0].src}
    ...
    return(
        ...
        <div className=" lg:mt-52 mt-10 lg:flex lg:flex-row md:flex md:flex-col flex flex-col px-12 lg:px-28">
            ...
            <div className="sectionImg">
                <img src={data.scholarship.program.photos[0].src} className="object-cover rounded-full h-56 w-60 lg:h-full lg:w-full flex items-center justify-center "></img>
            </div>
            </div>
